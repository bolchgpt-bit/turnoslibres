...
def reset_tables(engine):
    ...
    try:
        engine.execute(text("TRUNCATE TABLE professionals, beauty_centers, sports_complexes RESTART IDENTITY CASCADE;"))
    except Exception:
        # Fallback genérico
